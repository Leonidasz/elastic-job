...
public class CloudOperationRestfulApiTest extends AbstractCloudRestfulApiTest {
    ...
    @Test
    public void assertTaskSandbox() throws Exception {
        when(getRegCenter().getDirectly(HANode.FRAMEWORK_ID_NODE)).thenReturn("d8701508-41b7-471e-9b32-61cf824a660d-0000");
        assertThat(sentGetRequest("http://127.0.0.1:19000/api/operate/task/sandbox/"
                + "cpu_job_1@-@1@-@READY@-@d8701508-41b7-471e-9b32-61cf824a660d-S0@-@ede114f0-f2db-4bad-b0e0-e820a7d19c59"), is("127.0.0.1:9050/#/"
                + "agents/d8701508-41b7-471e-9b32-61cf824a660d-S0/browse?path=/home/gaohongtao/mesos/work-1.1.0/slaves/d8701508-41b7-471e-9b32-61cf824a660d-S0"
